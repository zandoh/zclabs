...
export const SpotifyFab = ({ setPlayerOpen }: { setPlayerOpen: Dispatch<SetStateAction<boolean>> }) => {
  const { data } = useQuery({
  ...
  return (
    <div
      className={twMerge(
        "fixed bottom-10 right-8 flex h-11 w-11 cursor-pointer items-center justify-center rounded-full",
